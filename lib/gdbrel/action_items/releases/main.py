...
from gdbrel.action_items.releases.create_release_tag\
    import AI as create_release_tag
from gdbrel.action_items.releases.create_tarballs\
    import AI as create_tarballs
from gdbrel.action_items.releases.unfreeze_branch\
...
from gdbrel.action_items.releases.upload_to_gnu\
    import AI as upload_to_gnu
from gdbrel.action_items.releases.announce_release_web\
    import AI as announce_release_web
from gdbrel.action_items.releases.update_online_docs\
    import AI as update_online_docs
from gdbrel.action_items.releases.update_ari\
...
from gdbrel.action_items.releases.bump_version_on_branch\
    import AI as bump_version_on_branch
from gdbrel.action_items.releases.error_if_unpublished_commits\
    import AI as error_if_unpublished_commits
...
class AI(AbstractReleaseCreationAI):
    ...
    def do_AI(self):
        info('Starting Meta Action Item: Release Creation '
             ' (version: ${hl_sbu}%(release.do_release)s${hl_ebu})...'
             % self.cfg)
