...
from gdbrel.action_items.branches.proof_read_gdb_readme\
    import AI as proof_read_gdb_readme
from gdbrel.action_items.update_head_branch\
    import AI as update_head_branch
from gdbrel.action_items.branches.create_release_branch\
    import AI as create_release_branch
from gdbrel.action_items.update_release_branch\
    import AI as update_release_branch
from gdbrel.action_items.branches.update_version_in\
    import AI as update_version_in
from gdbrel.action_items.branches.disable_devel_mode\
    import AI as disable_devel_mode
from gdbrel.action_items.branches.update_snapshots\
    import AI as update_snapshots
from gdbrel.action_items.branches.web_announce_branch\
    import AI as web_announce_branch
from gdbrel.action_items.branches.double_check_schedule\
    import AI as double_check_schedule
from gdbrel.action_items.branches.announce_branch_by_email\
    import AI as announce_branch_by_email
from gdbrel.action_items.branches.update_news_on_head_branch\
    import AI as update_news_on_head_branch
...
class AI(AbstractBranchCreationAI):
    ...
    def do_AI(self):
        ...
        for AI in (proof_read_gdb_readme,
                   update_head_branch,
